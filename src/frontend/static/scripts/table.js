// table_manager.js - Gestion du tableau des questions
...
class TableManager {
  ...
  renderTable(data = []) {
    ...
    if (this.elements.scrollCard) {
      this.elements.scrollCard.style.display = data.length ? "inline-block" : "none";
    }
  }
  ...
  setupEventListeners() {
    if (this.elements.loadButton) {
      this.elements.loadButton.addEventListener("click", () => this.loadQuestions());
    }
  }
